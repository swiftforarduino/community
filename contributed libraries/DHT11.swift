...
/* Snippets:
 {
        "DHT11":[
            {"partName":"Read Temperature and Humidity",
                "partCode":"let reading: (temperature: Int8, humidity: Int8, isValid: Bool) = readValues(pin: D2)"
            }
        ],
        "DHT22":[
            {"partName":"Read Temperature and Humidity",
                "partCode":"let reading: (temperatureTimesTen: Int16, humidityTimesTen: Int16, isValid: Bool) = readValuesDHT22(pin: D2)"
            }
        ],
 }
