...
; <label>:4:                                      ; preds = %3
  ...
  %7 = fmul float %6, 0x3F74050140000000
  %8 = call i1 @_TIF3AVR5printFT11unsignedIntVs6UInt1610addNewlineSb_T_A0_()
  call void @_TF3AVR5printFT11unsignedIntVs6UInt1610addNewlineSb_T_(i16 %5, i1 %8)
  %9 = call i1 @_TIF3AVR5printFT5floatSf10addNewlineSb_T_A0_()
  call void @_TF3AVR5printFT5floatSf10addNewlineSb_T_(float %7, i1 %9)
  call void @_TF3AVR5delayFT12millisecondsVs6UInt16_T_(i16 300)
  br label %3
}
...
declare void @_TF3AVR5printFT5floatSf10addNewlineSb_T_(float, i1) #0

declare i1 @_TIF3AVR5printFT5floatSf10addNewlineSb_T_A0_() #0
