...
public func disableOscillator(slaveAddress: UInt8) {
    blockingWriteSingleI2CRegister(slaveAddress: slaveAddress, register: 0x20)
}
...
public func turnOffLED(slaveAddress: UInt8) {
    blockingWriteSingleI2CRegister(slaveAddress: slaveAddress, register: 0x80)
}
